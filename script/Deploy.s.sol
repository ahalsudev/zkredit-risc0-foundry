...
contract QualifiedBorrowerDeploy is Script, RiscZeroCheats {
    ...
    function run() external {
        ...
        QualifiedBorrower qualifiedBorrower = new QualifiedBorrower(verifier);
        console2.log(
            "Deployed QualifiedBorrower to",
            address(qualifiedBorrower)
        );
